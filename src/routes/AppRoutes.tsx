...
import { AboutPage, ContactPage, NotFoundPage, OrderConfirmedPage } from '../pages/OtherPages'
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/pedido-confirmado"   element={<Layout><OrderConfirmedPage /></Layout>} />
